...
const PopUp = ({followerModal, setfollowerModal, profile, user, setcurProfile, setSearchTerm}) => {
          ...
          >
            <div className="relative  w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                {followers.map((foll) => <div className='flex relative flex-col z-[100] overflow-auto'>
                  <button className=' border-x-0 border-y-2 border-grey ' onClick={()=>{
