...
const ProjectCard = ({
  ...
  return (
      <motion.div variants={fadeIn("left", "spring", index * 0.5, 2)} className='flex'>
          <Tilt
              options={{
                  max: 45,
                  scale: 1,
...
const PredictiveSuggestions = () => {
  return (
    <div className="self-stretch overflow-hidden flex flex-row items-center justify-center flex-wrap-reverse px-2 sm:px-2 my-[2rem] relative gap-[60px] z-[5]">
        ...
        <div className=" flex flex-col items-start justify-start gap-[24px] z-[1]">
          <p className="m-0 self-stretch relative leading-[48px] text-[48px] font-bold">
          ...
          <div className="self-stretch flex flex-col items-start justify-center py-5 px-0 text-center text-xl">
            <div className="self-stretch flex flex-row items-center justify-center py-4 px-0 relative gap-[16px]">
              ...
              <div className="relative leading-[28px] font-medium text-right inline-block w-[200px] shrink-0 z-[2] text-[15px] sm:text-[20px]">
...
export default SectionWrapper(PredictiveSuggestions, "predictiveSuggestions")
